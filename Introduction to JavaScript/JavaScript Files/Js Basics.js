...
// and Js have right to access them.
...
const value = 20;
// value = 35; // will throw error, variable declared using const keyword can't be re-assign
...
//typeof Operator: tells the data type or nature of the variable or value
// null and array are JavaScript objects.
...
console.log(map); // {1 => 'Apple', 2 => 'Banana', 3 => 'Papaya'}

// Array reference vs. value copying
var arr = [1, 2, 3, 4, 5];
var brr = arr; // Copies the reference, not the values, that means now brr will also point to the address
// of the array where it stored in the heap memory
...
console.log("arr1: ", arr1); // [1, 2, 3, 4, 5] // not affected by popping of element from brr1
...
console.log("Copied Object: ", copiedObject); //Here spread operator only creates shallow copy
copiedObject.Age = 25;
