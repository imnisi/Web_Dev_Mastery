 ...
 * Js Functions.js
 * ------------------------------------------------
 * This script demonstrates basics concepts of functions in JavaScript.
 *
 * Topics Covered:
...
//? 4 is a literal number and not a valid identifier,so you get a syntax error.
...
//! Note: if you return the value implicitly, then you can use (value) brackets and if you want to return the value using
//! explicit "return" keyword then you must have to write "return" keyword inside the {} curly braces.

const addTwo = (num1, num2) => num1 + num2;
console.log(addTwo(7, 15)); // 22

const multiplyTwo = (num1, num2) => {
  return num1 * num2;
};

console.log(multiplyTwo(7, 15)); // 105

//? Let's say if we want to return an object, so we can't do like that {username: "nisi"}, it will give error,
//? so the best practice is to return an object ({username: "Nisi"})
