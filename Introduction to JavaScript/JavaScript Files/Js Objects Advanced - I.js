/**
 * Js Objects Advanced - I.js
 * ------------------------------------------------
 * This script demonstrates:
 *   - Examples and notes about object behavior (references, comparison, cloning, methods, destructuring, and JSON).
 */
...
object4.name = "Rama"; // Ignored
object4.age = 30; // Ignored
delete object4.name; // Ignored
...
object5.name = "Ramya"; // Changes name from Rukmini to Ramya
object5.age = 21; // Won't be added
delete object5.name; // Ignored

console.log(`Name: ${object5.name} and Age: ${object5.age}`); // Name: Ramya and Age: undefined

//* Object.preventExtensions(): can modify and delete existing, but can't add

const object6 = { name: "Radhika" };
object6.name = "Ramya"; // Works
object6.age = 30; // Ignored
delete object6.name; // Works
...
const personNew = { name: "Gopal", age: undefined };

console.log("name" in personNew); // true
console.log(personNew.hasOwnProperty("name")); // true
console.log("age" in personNew); // true
console.log(personNew.age !== undefined); // false

//* Best Practices:

// Safest
console.log(Object.prototype.hasOwnProperty.call(personNew, "name")); // true

// ES2022
console.log(Object.hasOwn(personNew, "name")); // true
